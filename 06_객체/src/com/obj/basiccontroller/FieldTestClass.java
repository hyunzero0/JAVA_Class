...
public class FieldTestClass {
	...
	//protected : 상속받은 클래스, 같은패키지에 있는 클래스에서 직접접근해서 데이터를 저장, 수정할 수 있음
	//default(생략) : 같은패키지에 있는 클래스에서 직접접근해서 데이터를 저장, 수정할 수 있음
	//private  : 클래스내부에서 직접접근해서 데이터를 저장, 수정할 수 있음
	//객체지향의 정보은닉으로 일반적인 클래스의 필드는 모두 private으로 선언함!!
	public int age;
	String name;
	private char gender;
