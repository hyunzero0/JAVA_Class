...
import com.poly.model.vo.Warrior;
...
public class CharacterMain {
	...
	public static void main(String[] args) {
		...
		GameController gc;
		switch(choice) {
			case 1: gc = new GameController(new Warrior(100, 1, "최주영", 80)); break;	
			...
			default : gc = new GameController(new Warrior()); break;
		}
		while(true) {
